...
public class ClienteDAO {
     ...
     * @return 
     */
    public boolean delete(ClienteModel cliente){
        for (ClienteModel clienteLista : Banco.cliente) {
     ...
     */
    private boolean idSaoIguais(ClienteModel cliente, ClienteModel clienteAComparar) {
