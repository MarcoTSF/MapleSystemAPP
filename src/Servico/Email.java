 ...
 */
public class Email {
    static final String REMETENTE_NOME = "EMAIL REMETENTE";
    static final String REMETENTE_SENHA = "SENHA REMETENTE";
     ...
     * @param mensagem  Mensagem que será enviada ao destinatário.
